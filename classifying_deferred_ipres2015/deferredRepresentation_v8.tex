...
\keywords{Web Architecture, HTTP, Web Archiving, Digital Preservation, Memento, TimeMaps}
...
\begin{figure*}
  \begin{center}
    \subfigure[The live-Web resource at URI-R \protect\url{http://www.truthinshredding.com/} loads resources A, B, and C via JavaScript.]{\label{liveex}\includegraphics[width=0.3\textwidth]{./imgs/Live.png}}\qquad
  ...
  \end{center}
\vskip -3mm
  \caption{Neither archival tool captures all embedded resources, but PhantomJS discovers the URI-Rs of two out of three embedded resources dependent upon JavaScript (B, C) while Heritrix misses them.}
  \label{motivate}
\end{figure*}
...
\multicolumn{1}{c}{\multirow{2}{*}{Crawler}} & \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Crawl time\\ (URIs/sec)\end{tabular}} & \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Frontier Size\\ (URIs)\end{tabular}} \\
\multicolumn{1}{c}{}                         & $\mu$                                   & $\sigma$                                  & $\mu$                                   & $\sigma$                                 \\
\hline
\hline
...
\begin{figure}
  \begin{center}
    %\subfigure[A portion of the Heritrix, PhantomJS, and wget frontiers overlap, and PhantomJS and Heritrix identify URIs that the others do not.]{\label{unionInt}\includegraphics[width=0.5\textwidth]{./imgs/unionStatsTotal.png}}\qquad
    %\subfigure[The frontier of URI-Rs unique to PhantomJS shrinks when only considering the host and path aspects (the Base Policy for matching) of the URI-R.]{\label{fuzzy}\includegraphics[width=0.5\textwidth]{./imgs/unionStatsFuzzy.png}}  \qquad
     \subfigure[A portion of the Heritrix, PhantomJS, and wget frontiers overlap, and PhantomJS and Heritrix identify URIs that the others do not.]{\label{unionInt}\includegraphics[width=0.3\textwidth]{./imgs/unionIntPPt.png}}\\
    \subfigure[The frontier of URI-Rs unique to PhantomJS shrinks when only considering the host and path aspects (Base Policy for matching) of the URI-R.]{\label{fuzzy}\includegraphics[width=0.3\textwidth]{./imgs/fuzzy2PPt.png}}
  \end{center}
...
This analysis shows that PhantomJS finds 19.70 more embedded resources per URI than Heritrix (Figure \ref{frontierGrowth}). Heritrix runs 12.13 times faster than PhantomJS (Figure \ref{speedGrowth}).%, the crawler needs to avoid crawling 1.62 URI-Rs with non-deferred representations for every URI-R with a deferred representation to maintain an optimal performance trade-off.
...
\item \textbf{JavaScript Tags}: We counted the number of script tags with JavaScript, both in files and embedded code.
...
\item \textbf{Ajax (in HTML)}: To estimate the number of Ajax calls (e.g., \texttt{\$.get()}, \texttt{XmlHttpRequest}) we counted the number of occurrences of Ajax requests in JavaScript tags embedded in the DOM.
...
\item \textbf{Missed, Different Domain}: Using PhantomJS, we counted the number of embedded resources originating outside of the URI-R's TLD that were not successfully dereferenced (i.e., returned a class 400 or 500 HTTP response code).
\end{enumerate}
\vskip -2mm
...
\begin{table}[h]
\begin{tabular}{l|l|l|l}
Crawl Strategy                                                                     & \begin{tabular}[c]{@{}l@{}}Crawl Time\\ (hrs)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Crawl Rate\\ (URIs/sec)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Frontier Size\\ (URIs)\end{tabular} \\ 
\hline
\hline
...
\begin{table}[h]
\begin{tabular}{lllll}
Crawler                     & URI-R Set                         & \begin{tabular}[c]{@{}l@{}}Seed \\ Size\end{tabular} & \begin{tabular}[c]{@{}l@{}}Frontier \\ Size\end{tabular} & \begin{tabular}[c]{@{}l@{}}Crawl \\ Time\end{tabular}                                                                             \\ \hline
\multicolumn{1}{|l|}{P}   & \multicolumn{1}{l|}{Deferred}     & \multicolumn{1}{l|}{5,187}                           & \multicolumn{1}{l|}{311,903}                             & \multicolumn{1}{l|}{84.9 hrs}  \\ \hline
\multicolumn{1}{|l|}{H} & \multicolumn{1}{l|}{Non-deferred} & \multicolumn{1}{l|}{4,813}                           & \multicolumn{1}{l|}{124,728}                             & \multicolumn{1}{l|}{23.6 hrs}   \\ \hline
\multicolumn{1}{|l|}{H} & \multicolumn{1}{l|}{Deferred}     & \multicolumn{1}{l|}{5,187}                           & \multicolumn{1}{l|}{171,499}                             & \multicolumn{1}{l|}{26.7 hrs}   \\ \hline
\multicolumn{1}{|l|}{P}   & \multicolumn{1}{l|}{All URI-Rs}   & \multicolumn{1}{l|}{10,000}                          & \multicolumn{1}{l|}{438,388}                             & \multicolumn{1}{l|}{686 hrs}\\ \hline
\multicolumn{1}{|l|}{H} & \multicolumn{1}{l|}{All URI-Rs}   & \multicolumn{1}{l|}{10,000}                          & \multicolumn{1}{l|}{275,234}                             & \multicolumn{1}{l|}{48.3  hrs}\\ \hline
\multicolumn{1}{|l|}{Two-tier} & \multicolumn{1}{l|}{All URI-Rs}   & \multicolumn{1}{l|}{10,000}                          & \multicolumn{1}{l|}{399,202}                             & \multicolumn{1}{l|}{133 hrs} \\ \hline
\end{tabular}
