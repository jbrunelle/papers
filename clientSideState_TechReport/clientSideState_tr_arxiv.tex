...
\begin{figure*}[hp]
\centering
%\includegraphics[height=0.98\textheight]{./realStates4H.png}
...
\begin{figure*}[hp]
\centering
%\includegraphics[height=0.98\textheight]{./realStates_leftH.png}
...
\begin{figure*}[hp]
\centering
%\includegraphics[height=0.98\textheight]{./realStates_rightH.png}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.48\textwidth]{./newByEventHorz.png}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.48\textwidth]{./growth1.png}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.48\textwidth]{./ROIint.png}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.5\textwidth]{./unarchivedByMime.png}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.5\textwidth]{./mimeSizeHisto.png}
...
\begin{figure}
  \begin{center}
    ...
    %\subfigure[Unarchived image sizes are, on average, 3.5KB.]{\label{mimesizes}\includegraphics[width=0.45\textwidth]{./mimeSizeHisto.png}}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.48\textwidth]{./growth2a.png}
%\caption{}
%\label{growth2a}
%\end{figure}
...
%\begin{figure}
%  \begin{center}
%    \subfigure[Each descendant contributes to the overall frontier size, with $s_1$ providing the greatest contribution and $s_0$ and $s_2$ providing approximately equal contributions.]{\label{growth2a1}\includegraphics[width=0.48\textwidth]{./growth2a_split1.png}}\\
%    \subfigure[Deferred representations contribute to most of the unarchived embedded resources.]{\label{growth2a2}\includegraphics[width=0.48\textwidth]{./growth2a_split2.png}}  
%  \end{center}
...
%\begin{figure}
%  \begin{center}
%    \subfigure[Embedded resources discovered in $s_1$ and $s_2$ are much more frequently unarchived (92\% and 96\%, respectively) than $s_0$ (12\% unarchived).]{\label{growth2a2}\includegraphics[width=0.48\textwidth]{./archivedByDepthPctHorz.png}}\\
%    \subfigure[Crawling $s_1$ provides the greatest contribution to $RP$; the additions to the crawl frontier by $s_0$ (10,623) and $s_1$ (10,208) only differ by 415 URIs.]{\label{growth2a1}\includegraphics[width=0.48\textwidth]{./tree_diagram.png}}  
%  \end{center}
%  \caption{The number of new URI-Rs discovered at $s_2$ is much less than that at $s_1$. Further, the archival coverage reduces deeper into the tree.}
%  \label{growth2a}
%\end{figure}
...
%\begin{figure}
%  \begin{center}
%    \subfigure[The occurrence of embedded resources loaded into deferred representation descendants.]{\label{longtail}\includegraphics[width=0.48\textwidth]{./longTail.png}}\\
%    \subfigure[A CDF of the contributions of each URI-R and its descendants to $RP$.]{\label{cdf}\includegraphics[width=0.48\textwidth]{./cdfURIs.png}}  
%  \end{center}
...
%\begin{figure*}
%  \begin{center}
%    \subfigure[]{\label{}\includegraphics[width=0.3\textwidth,height=3cm,keepaspectratio]{./}}
%    \subfigure[]{\label{}\includegraphics[width=0.3\textwidth]{./}}  
%  \end{center}
%  \caption{}
%  \label{}
%\end{figure*}
