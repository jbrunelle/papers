...
To mitigate the impact web developers' practice of using JavaScript and Ajax to load embedded resources, crawlers like Heritrix have constructed approaches for extracting links from embedded JavaScript to be added to crawl frontiers  \cite{htrixJS} (most recently, Google's crawler \cite{googleJS}).
...
\bibitem{temporalCoherence}
Ainsworth, S.G., Nelson, M.L.: Evaluating sliding and sticky target policies by
  measuring temporal drift in acyclic walks through a web archive.
\newblock International Journal on Digital Libraries pp. 1--16 (2014).
\newblock \doi{10.1007/s00799-014-0120-4}

\bibitem{yasminLinks}
Alnoamany, Y., Alsum, A., Weigle, M., Nelson, M.: {Who and What Links to the
  Internet Archive}.
\newblock In: {Proceedings of the Third International Conference on Theory and
  Practice of Digital Libraries}, pp. 346--357. ACM (2013).
\newblock \doi{10.1007/978-3-642-40501-3_35}

\bibitem{archivetoday}
{Archive.today}: Archive.today.
\newblock \url{http://archive.today/} (2013).
\newblock \url{http://archive.today/}

\bibitem{ipresArchivability}
Banos, V., K.~Yunhyong, S.R., Manolopoulos, Y.: {CLEAR: a credible method to
  evaluate website archivability}.
\newblock In: Proceedings of the 9th International Conference on Preservation
  of Digital Objects (2013)

\bibitem{saad2011}
{Ben Saad}, M., Gançarski, S.: Archiving the web using page changes patterns:
  A case study.
\newblock In: {Proceedings of the 11th Annual International Joint Conference on
  Digital Libraries}, pp. 113--122 (2011).
\newblock \doi{10.1145/1998076.1998098}

\bibitem{saadIJDL}
{Ben Saad}, M., Gançarski, S.: Archiving the web using page changes patterns:
  a case study.
\newblock International Journal on Digital Libraries \textbf{13}(1), 33--49
  (2012).
\newblock \doi{10.1007/s00799-012-0094-z}

\bibitem{saadTPDL}
{Ben Saad}, M., Pehlivan, Z., Gançarski, S.: Coherence-oriented crawling and
  navigation using patterns for web archives.
\newblock In: Proceedings of the First International Conference on Theory and
  Practice of Digital Libraries, pp. 421--433 (2011)

\bibitem{googleJS}
Brunelle, J.F.: {Google and JavaScript}.
\newblock
...
\newblock \doi{10.1007/s00778-011-0219-9}
...
\newblock \doi{10.2196/jmir.7.5.e60}
...
\newblock Information Processing \& Management \textbf{44}(4), 1431 -- 1447
  (2008).
\newblock \doi{10.1016/j.ipm.2007.11.003}
...
\newblock \doi{10.1045/may2013-gray}
...
\newblock \doi{10.1007/978-3-642-40501-3_5}
...
\newblock \doi{10.1145/1718487.1718542}
...
\newblock \doi{10.1145/2232817.2232819}
...
\newblock \doi{10.1007/978-3-642-33290-6_14}

\bibitem{hanyTPDL2013}
...
\newblock \doi{10.1007/978-3-642-40501-3_34}
...
\newblock In: Proceedings of the 2009 ACM Symposium on Applied Computing, pp.
  1806--1810 (2009).
\newblock \doi{10.1145/1529282.1529686}

\bibitem{blockImportance}
...
\newblock In: {Proceedings of the 13th international conference on World Wide
  Web}, pp. 203--211 (2004).
\newblock \doi{10.1145/988672.988700}
...
\newblock \doi{10.1145/956750.956785}
...
\newblock \doi{10.1109/TMM.2013.2268053}
