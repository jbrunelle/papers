...
\begin{figure*}[h!t]
  \begin{center}
    ...
    \subfigure[This memento (URI-M \protect\url{http://web.archive.org/web/20110116022653/http://www.cityofmoorhead.com/flood/?}) is missing two style sheets which changes the entire appearance and utility of the memento (\emph{$M_m$=0.38}).]{\label{missingflood}\includegraphics[width=0.45\textwidth]{./imgs/missing_flood_page_crop.png}}\qquad
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[Occurrences of missing embedded resource numbers in WebCite as a histogram.]{\label{missingDistroWCHisto}\includegraphics[width=0.50\textwidth]{./imgs/OccStats_webcite.png}}\\
    \subfigure[Distribution of missing embedded resources within the collection of WebCite mementos as a CDF.]{\label{missingDistroWCCdf}\includegraphics[width=0.50\textwidth]{./imgs/occStatsCDF09.png}}  
  \end{center}
  \label{missingDistroWC}
  \caption{The distribution of the number of missing embedded resources per URI-M in WebCite.}
\end{figure}
