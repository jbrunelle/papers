...
\begin{figure}
  \begin{center}
    ...
    \subfigure[Users may seelect the option of viewing the mementos of the currently viewed page.]{\label{mems}\includegraphics[width=0.2\textwidth]{./imgs/viewmems.png}}  
  \end{center}
